...
def python_data_stream_example():
    ...
    ds.window_all(SlidingProcessingTimeWindows.of(size=Time.seconds(30), slide=Time.seconds(10))) \
        .reduce(TemperatureReducer()) \
...
class TemperatureReducer(ReduceFunction):
